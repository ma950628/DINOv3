...
class MultiDistillationMetaArch(SSLMetaArch):
    ...
    def get_teacher_output(
        ...
        *,
        ...
        # Multidistillation codepath:
        # ===== MODIFICATION: iBOT disabled, comment out the following lines =====
        ...
        # For compatibility, set masked_patch_centered to None
        ...
        # ===== MODIFICATION: iBOT disabled, do not compute masked_patch_centered =====
        ...
        return {
            ...
            "masked_patch_centered": masked_patch_centered,  # [n_masked_patches, K] or None
        }