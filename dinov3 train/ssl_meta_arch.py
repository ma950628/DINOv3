...
class SSLMetaArch(nn.Module):
    ...
    def get_teacher_output(
        ...
        *,
        ...
        # ibot_patch = backbone_out["x_norm_patchtokens"]  # [n_crops * B, P, D]  # Not used anymore

        # ===== MODIFICATION: iBOT disabled, skip computation of masked_patch_centered =====
        ...
        return {
            ...
            # "patch_pre_head": ibot_patch.unflatten(0, [n_crops, B]),  # Not needed without iBOT/Gram
            "cls_after_head": cls_after_head.unflatten(0, [n_crops, B]),  # [n_crops, B, K]
            "cls_centered": cls_centered,  # [n_crops, B, K]
            "masked_patch_centered": masked_patch_centered,  # None
        }
    ...
    def get_student_output(self, *, global_crops, local_crops, upperbound, masks, mask_indices_list):
        ...
        # ===== MODIFICATION: iBOT disabled, skip computation of masked patch head =====
        ...
        global_masked_patch_after_head = None
        masked_patches_pre_head = None
        # ===== END MODIFICATION =====
        ...
        global_out = {
            ...
            "masked_patch_after_head": global_masked_patch_after_head,  # None
            "masked_patch_pre_head": masked_patches_pre_head,  # None
        }
        local_out = {
    ...
    def compute_losses(
        ...
        *,
        ...
        # ===== MODIFICATION: All other losses (KoLeo, iBOT, Gram) are commented out =====
